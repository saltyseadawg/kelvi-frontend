    ...
    return(
        <div>
            <Navbar></Navbar>
                ...
                <iframe className="py-4" src="https://docs.google.com/forms/d/e/1FAIpQLSeRux6di2mWrHpxImJmFDrqVcAkMKQ8smFfjBAKRpa40F_4yw/viewform?embedded=true" width="100%" height="1159" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
            </div>
        </div>
    )
}